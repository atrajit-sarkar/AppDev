            ...
            if (isFocused && searchinputtext.value != "") {
                ...
                items(userList) { contact ->
                    ...
                    if (messages.isNotEmpty()) {
                        ...
                        if (messages.last().password != "" || messages.last().viewOnce != "") {
                            contact.recentMessage =
                                if (messages.last().sender == auth.currentUser?.uid) "You sent a Protect Message" else "He sent a Protect Message"
                        } else {
                            contact.recentMessage =
